...
public class HomeScreen {
	...
	public static final String LIKED_PRODUCTS_LINK_XPATH	= "//a[contains(text(),'Sản phẩm yêu thích')]";
	public static final String ORDERED_PRODUCTS_LINK_XPATH	= "//a[contains(text(),'Đơn hàng của tôi')]";
	public static final String CHANGE_PASSWORD_LINK_XPATH	= "//a[contains(text(),'Đổi mật khẩu')]";
	...
	public static final String LIKE_BTN_XPATH 				= "(//button[@class='link-wishlist btn-add-to-wishlist'])[INDEX]";
	public static final String LIKE_PRODUCT_MSG 			= "Sản phẩm đã được thêm vào danh sách yêu thích";
	public static final String LIKE_PRODUCT_INVALID_MSG		= "Sản phẩm đã tồn tại trong danh sách yêu thích của bạn!";
